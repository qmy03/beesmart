...
//                 <Image src="/score.png" width={80} height={80} alt="" />
//                 <Box>
...
//               </Box>
//               <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
//                 <Image src="/clock.png" width={80} height={80} alt="" />
//                 <Box>
//                   <Typography fontSize={32} fontWeight={600}>
...
//               </Box>
//               <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
//                 <Image src="/list.png" width={80} height={80} alt="" />
//                 <Box>
//                   <Typography fontSize={32} fontWeight={600}>
...
//                   <Box>
//                     {question.correctAnswers.map((correctAnswer, ansIndex) => {
//                       const isCorrect =
                      ...
                      question.options
                        ...
                        .map((option, optIndex) => (
                          <>
                            ...
                            >
                              <Box
                                sx={{ width: "40px", backgroundColor: "#e9e9e9" }}
                              ></Box>
